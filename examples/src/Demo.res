...
let make = (~data) =>
  <div>
    ...
    <ChartDemo title="Bar Chart">
      <ResponsiveContainer height=Px(200.) width=Prc(100.)>
        <BarChart barCategoryGap=Px(1.) margin={"top": 0, "right": 0, "bottom": 0, "left": 0} data>
    ...
    <ChartDemo title="Area Chart">
      <AreaChart width=500 height=400 data margin={"top": 10, "right": 30, "left": 0, "bottom": 0}>
    ...
    <ChartDemo title="Composed Chart">
      <ComposedChart
        width=500 height=400 data margin={"top": 20, "right": 20, "bottom": 20, "left": 20}>
    ...
    <ChartDemo title="Pie Chart">
      <PieChart width=400 height=400>
        <Pie data dataKey="uv" cx=Px(200.) cy=Px(200.) outerRadius=Px(60.) fill="#8884d8" />
        <Pie
          data
          dataKey="amt"
          cx=Px(200.)
